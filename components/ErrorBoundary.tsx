...
class ErrorBoundary extends React.Component<Props, State> {
  // FIX: Reverted to using a constructor for state initialization. The `this.props`
  // object was not being correctly recognized on the component instance. Using a
  // constructor and explicitly calling `super(props)` is the most robust way to ensure
  // proper component initialization and resolve this type of error.
