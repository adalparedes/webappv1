...
class ErrorBoundary extends React.Component<Props, State> {
  // Fix: The constructor-based state initialization was causing errors where `this.state` and `this.props` were not recognized.
  // This change reverts to using class property syntax, which is the modern standard for initializing state in React class components and should resolve the issue.
