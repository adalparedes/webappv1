          ...
          <div className="bg-black/60 p-5 rounded-[2.5rem] border border-white/10 space-y-3 shadow-2xl">
            ...
            <div className="mt-6 pt-4 border-t border-white/10 space-y-4">
              ...
              <button 
                ...
                className={`w-full py-5 font-orbitron font-bold text-[10px] rounded-2xl uppercase shadow-lg transition-all tracking-widest ${(!selectedPlanId || !paymentMethod || !termsAccepted || isProcessing) ? 'bg-gray-800 text-gray-600' : (selectedPlan?.id === 'PREMIUM' ? 'bg-[#ffcc00] text-black shadow-[0_0_30px_rgba(255,204,0,0.3)]' : 'bg-[#00ff88] text-black shadow-[0_0_30px_rgba(0,255,136,0.3)]')}`}
              >
